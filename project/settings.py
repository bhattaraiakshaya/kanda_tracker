...
INSTALLED_APPS = [
    'kanda_tracker.apps.KandaTrackerConfig',
    'rest_framework',
    'drf_yasg',
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', default='mydatabase'),
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'kanda_tracker.error_handling.custom_exception_handler',
}
